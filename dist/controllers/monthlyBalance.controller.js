...
var mostrarVentasMes = /*#__PURE__*/function () {
  ...
  return function mostrarVentasMes(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var ingresosMes = /*#__PURE__*/function () {
  ...
  return function ingresosMes(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
var egresosMes = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          ...
          _context3.next = 6;
          return connection.query("SELECT COALESCE(SUM(total), 0) as Egresos FROM facturas WHERE total < 0 AND MONTH(fecha) = MONTH(CURDATE()) AND YEAR(fecha) = YEAR(CURDATE())");
        case 6:
  ...
  return function egresosMes(_x5, _x6) {
